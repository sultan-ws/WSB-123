    ...
    <div className="flex flex-col gap-3 py-6">
      ...
      <div className="py-5 border-t border-gray-300">
        ...
        <div className="flex flex-col gap-3">
          <input className="p-3 border text-[#757575] text-[14px] font-semibold border-[#757575] " type="text" placeholder="Email Address" />
          <input className="p-3 border text-[#757575] text-[14px] font-semibold border-[#757575] " type="number" placeholder="OTP" />
          <input className="p-3 border text-[#757575] text-[14px] font-semibold border-[#757575] " type="text" placeholder="Password" />
